HOMEWORK 4.1
Question: Which of the following best describes AngularJS directives?
Answer: A directive associates an AngularJS template with its corresponding JavaScript functionality, such as a controller 

HOMEWORK 4.2 
Question: Which of the following $http calls violates the same-origin policy for HTTP requests, assuming that your server is running on http://localhost:3000?
Answer: $http.get('http://localhost:8080/test')
